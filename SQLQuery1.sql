...
-- tee kıik ¸lesanded l‰bi SQL Server'is
...
--add constraint __ check- kontrollib, kas kirjed tˆˆtavad uue piirangu lisamisel
alter table Person
...
--go- Saadab k‰su kıigi eelnevate SQL-lausete t‰itmiseks
select * from Person
go
...
---Select * from Person where (City = 'Gotham' vıi City = 'New York') ja Age >= 40 p‰ring tagastab kıik tabelist Isik olevad read, kus on j‰rgmised tingimused:Veeru City v‰‰rtus on kas ÑGothamî vıi ÑNew Yorkî ja veeru Vanus v‰‰rtus on suurem kui 40 vıi sellega vırdne.
...
--arvutab tabeli kıigi kirjete vanuste summa
